...
OUTPUT_PATH = Path("/Users/linachiomaanaso/CODIO_PROJECTS/MOVIE Project/Movie Project-OOP + Web + Extra Features/src/data/country_map.py")
...
def main() -> None:
	...
	code_to_name, name_to_code = build_mappings(data)
	write_python_module(code_to_name, name_to_code)
